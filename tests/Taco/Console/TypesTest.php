...
class TypesTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->setExpectedException('Taco\Console\TypeException', "Unrecognizable type of male|female|alien: empty.");
	...
	{
		$this->setExpectedException('Taco\Console\TypeException', "Unrecognizable type of male|female: `alien'.");
		$t = new TypeEnum(['male', 'female']);
		$t->cast('alien');
	}
