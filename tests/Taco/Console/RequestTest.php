...
class RequestTest extends PHPUnit_Framework_TestCase
{
	...
	function testEmpty()
	{
		...
		$this->assertTrue($req->isFilled(), 'Nejsou pravidla, tudíž všechno by mělo být zpracováno.');
		$this->assertEquals(new Options([]), $req->getOptions());
	}
	...
	function testEmptyWithOptionAndDefault()
	{
		$req = $this->getRequest();
