...
class OptionSignatureTest extends PHPUnit_Framework_TestCase
{
	 ...
	 */
	function _testRequiredArgument1()
	{
	...
	{
		$sig = new OptionSignature();
		$sig->addFlag('help|h', 'Help command');

		$this->assertEquals(['help'], $sig->getOptionNames());
		$this->assertEquals('h', $sig->getOption('help')->getShortname());
	}
